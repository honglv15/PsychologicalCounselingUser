...
;( function( factory ) {
	if ( typeof define === "function" && define.amd ) {
		...
		define( [ "web/3rd/zui-1.9.2-dist/dist/lib/jquery/jquery" ], function (jQuery ) {
		...
		module.exports = factory( require( "web/3rd/zui-1.9.2-dist/dist/lib/jquery/jquery" ), window );
	} else {
